...
<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>" class="default">
	...
	<h1 class="headingleft">Novo usuário <small>(<a href="<?php echo site_url('/admin/users'); ?>">Voltar para usuários</a>)</small></h1>
...
<ul class="innernav clear">
	...
	<?php if (@in_array('shop', $this->permission->sitePermissions) || @in_array('community', $this->permission->sitePermissions)): ?>	
		<li><a href="#tab2" class="showtab">Endereços</a></li>
...
<?php if (@in_array('users_groups', $this->permission->permissions)): ?>
	...
	?>
	<span class="tip">Para editar a permissão clique em 'Grupos de usuários' na aba de Usuários.</span>
	<br class="clear" />
<?php endif; ?>
	...
	<span class="tip">Para uso dos fóruns (opcional).</span></span><br class="clear" />
...
<?php if (@in_array('shop', $this->permission->sitePermissions) || @in_array('community', $this->permission->sitePermissions)): ?>	
	...
	<p><input type="checkbox" name="sameAddress" value="1" class="checkbox" id="sameAddress" />Usar o mesmo endereço de entrega.</p>
